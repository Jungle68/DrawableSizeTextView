...
/**
 * @Describe this textview  can set drawable size in local xml
 * @Author Jungle68
 * @Date 2015/3/13
...
public class DrawableSizeTextView extends TextView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        try {
            mDrawableWidth = array.getDimensionPixelSize(R.styleable.DrawableSizeTextView_drawableWidth, -1);
            mDrawableHeight = array.getDimensionPixelSize(R.styleable.DrawableSizeTextView_drawableWidth, -1);
        } finally {
            array.recycle();
        }
